...
const villaImages = [
  "/woodenvilla/villa1.jpg",
  "/woodenvilla/villa2.jpg",
  "/woodenvilla/villa3.jpg",
  "/woodenvilla/villa4.jpg",
  "/woodenvilla/villa5.jpg",
  "/woodenvilla/villa6.jpg",
];

const WoodenVillaSeries = (props: Props) => {
  ...
  return (
    <div className="w-full px-0 md:px-4 lg:px-16 mb-6 lg:mb-10">
      <div className="flex items-end justify-between w-full">
        <div className="flex flex-col">
          ...
          <p className="text-secondary-darkest font-medium  lg:text-lg leading-6 lg:leading-8">
            2 Bedroom, Hall and Kitchen (BHK)
          </p>
        </div>
        <Link
          href="#"
      ...
      <div className="relative w-full  mt-1.5 lg:mt-3">
        ...
        <button
          className={`absolute top-1/2 -right-5 bg-white rounded-full transform -translate-y-1/2 ${
...
export default WoodenVillaSeries;
