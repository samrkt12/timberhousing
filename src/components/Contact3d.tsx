          ...
          <div className="w-full h-full flex items-center py-6 lg:py-8">
            ...
            <div className="relative z-10 flex flex-col my-auto items-start max-w-[15rem] md:max-w-[32rem] lg:max-w-[42rem] p-2 lg:p-6 text-whites-light">
              ...
              <p className="text-sm md:text-base lg:text-lg font-light max-w-[38ch] text-whites-light/75 mb-3 md:mb-5 lg:mb-8">
                Contact us today and take the first step to building your
                forever home.
              </p>
              <Button
                onClick={handleContactClick}
                className="flex items-center font-bold uppercase bg-gradient-to-r from-[#EA6043] to-[#D75337] hover:from-[#D75337] hover:to-[#EA6043] text-white text-sm lg:text-base px-6 lg:px-8 py-3 rounded-lg shadow-md transition-colors duration-300"
              >
                Contact now
