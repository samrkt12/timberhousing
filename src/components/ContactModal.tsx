...
const ContactModal: React.FC<ContactModalProps> = ({ isOpen, onClose }) => {
  ...
  return createPortal(
    ...
    >
      <div
        className="modal-content bg-white px-[50px] py-10 rounded-[28px] w-[900px] border-[5px] border-[#D75337] relative mt-8 max-h-[85vh] overflow-y-auto"
      ...
      >
        ...
        {/* Contact information*/}
        <div className="bg-[#FAFAFA] rounded-[10px] px-3 py-4 flex items-center justify-between text-[#343434]">
          <div className="">
