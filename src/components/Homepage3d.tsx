      ...
      <div className="flex w-full items-center justify-between gap-2">
        <div className="text-center lg:text-left mx-auto lg:mx-0">
          ...
          <p className="text-[#636363] text-sm lg:text-lg font-light">
            Our personalized wooden houses 3D model gives you a clear, realistic
            view of your unique home design.
          </p>
        </div>
        <div className="hidden  h-full  lg:flex items-center justify-center">
          <Button className="py-1 lg:py-3 rounded-[10px] px-1 lg:px-5 lg:tracking-wide text-sm font-semibold">
            Get a free quote
          </Button>
        </div>
      </div>
