      ...
      <div className="px-2">
        ...
        <div className="text-[#292929] border border-[#DFDFDF] rounded-[10px] py-1 pb-0 mb-3">
          <div className="flex justify-between text-sm mb-2 px-2">
            ...
            <span className="text-[#1B1B1B] leading-5">{model.floorCount}</span>
          </div>
          <div className="flex justify-between text-sm mb-2 bg-[#F9F9F9] py-1 px-2">
            <span className="font-light text-base leading-5">
              No. of bedrooms:
            </span>
          ...
          <div className="flex justify-between text-sm bg-[#F9F9F9] py-1 px-2">
            <span className="font-light text-base leading-5">Total area:</span>
            <span className="text-[#1B1B1B] leading-5">
