...
const ContactForm = (props: Props) => {
  ...
  return (
    <div className=" bg-whites-light px-5 lg:px-7 py-3.5 lg:py-5 rounded-xl border-[3px] border-primary-light max-w-[800px] mx-auto lg:mx-0">
      <h3 className="flex flex-row justify-center text-[22px] leading-9 lg:text-2xl lg:leading-10 font-medium text-whites-darkest mb-4 text-center">
        Book
      ...
      <form className="space-y-4">
        {/* Name Field */}
        <div>
          <label className="block text-base lg:text-lg text-[#474747] font-normal mb-1">
            Name:
          </label>
          <input
            type="text"
            placeholder="Satyam S."
            className="w-full px-2 py-3 bg-[#F8F8F8] rounded-lg  focus:outline-primary-base"
          />
        </div>
        ...
        <button
          type="submit"
          className="flex items-center justify-center w-full bg-primary-base hover:bg-primary-dark text-whites-light py-3 rounded-lg  lg:text-lg font-medium transition-all duration-200"
        >
          Meet our architect
