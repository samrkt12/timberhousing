...
import { ProjectData } from "@/utils/modelsData";
...
const ProjectsCarousel = ({ model, index }: Props) => {
    ...
    <>
      {lightboxOpen && (
        <Lightbox
          ...
          index={0}
          slides={model.images.map((src) => ({ src }))}
      ...
      <div className="relative z-20 flex flex-col  w-full lg:max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12 py-5 lg:py-7 max-w-[715px] overflow-hidden">
        ...
        <div className="flex justify-between items-center mb-3 lg:mb-6">
          ...
          <button className="hidden lg:flex bg-[#4D4453] text-whites-light py-[7px] px-[30px] rounded-[62px] font-medium text-[17px] leading-8  gap-2 items-center justify-center group ">
        ...
        <div className="flex lg:hidden items-center justify-center w-full sm:px-4 lg:px-0">
          <button className="bg-[#4D4453] w-full max-w-[400px] text-whites-light py-[5.5px] lg:py-[7px] px-5 lg:px-[30px]  rounded-[62px] font-medium text-[15px] lg:text-[17px] leading-7 lg:leading-8 flex gap-2 items-center justify-center group ">
