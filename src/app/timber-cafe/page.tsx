...
const Page = () => {
  ...
  const villaModels = modelsData.filter(
    (model) => model.category === "Timber Cafe"
  );
  ...
  return (
    <div className="relative w-full overflow-hidden">
          ...
          <div className="w-full my-5 lg:my-8 mb-10 lg:mb-16">
            <div className="flex items-center justify-center mb-2.5">
              ...
              <h2 className="mx-1 text-2xl lg:text-[42px] lg:leading-[46px]  font-semibold whitespace-nowrap">
                Timber <span className="text-primary-base">Cafe</span>
              </h2>
              <Image
                src="/vector2.png"
                width={350}
      ...
      <div className="relative z-20 flex flex-col h-full w-full max-w-screen-xl mx-auto px-3 sm:px-4 md:px-8 lg:px-12 py-10">
        <div className="relative  bg-whites-light shadow-lg -top-24 rounded-[10px] flex flex-col lg:flex-row lg:justify-evenly lg:text-center lg:items-center px-3 lg:px-4 py-2 lg:py-6">
